    ...
    <>
        ...
        <div className="container text-center text-white">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              />
              <button type="button" className="btn btn-light btn-lg px-5 py-3">BOOK A RESERVATION</button>
            </div>
          </div>
        </div>
            ...
            <div className="col-lg-6 d-flex flex-column justify-content-center text-center text-lg-start text-white mb-4 mb-lg-0">
              <div className="restaurant-guru-badge mb-5">
                <div className="badge-inner">
                  ...
                  <span className="badge-text-middle">
              ...
              <p className="lead">
                The Shamrock Irish Pub & Eatery specializes in authentic Irish charm
                and hospitality. The food is a fusion of traditional Irish and
                American favorites. Live music is one of our many exciting factors
                in the success of the pub, mostly with a Celtic flavor to ensure
                we maintain our heritage and authenticity.
              </p>
            </div>
            ...
            <div className="col-lg-6">
              <div className="reviews-box bg-light p-5 rounded-3">
                ...
                <p className="text-muted mb-4">
                  See what our customers are saying about The Shamrock Pub & Eatery
                  Murrieta CA
                </p>
                ...
                <div id="reviewCarousel" className="carousel slide" data-bs-ride="carousel">
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                      <blockquote className="blockquote">
                        <p className="text-dark">
                          &quot;Great food and beer! Atmosphere is always fun! Make
                          sure to do a reservation and if you&apos;re a party of 2
                          you should reserve as a party of 4.&quot;
                        </p>
                    ...
                    <div className="carousel-item">
                      <blockquote className="blockquote">
                        <p className="text-dark">
                          &quot;This is my favorite bar in the Temecula/Murrieta
                          area. They have live entertainment throughout the week,
                          and the food is spot on.&quot;
                        </p>
                        <footer className="blockquote-footer text-irish-green">
                          <strong>Samantha A.</strong>
                          {' '}
                          <cite>Murrieta, CA</cite>
                        </footer>
                      </blockquote>
                    </div>
                    ...
                    <div className="carousel-item">
                      <blockquote className="blockquote">
                        <p className="text-dark">
                          &quot;Great service, awesome food, and amazing people.
                          Their team is very attentive as it is busy as soon as
                          the doors open.&quot;
                        </p>
                        <footer className="blockquote-footer text-irish-green">
                          <strong>Wen N.</strong>
                          {' '}
                          <cite>Moreno Valley, CA</cite>
                        </footer>
                      </blockquote>
                    </div>
                  </div>
                ...
                <div className="text-center mt-4">
                  <p className="mb-3 text-dark">
                    Love The Shamrock Irish Pub & Eatery Murrieta, CA?
                    <br />
                    <strong>Please Share Your Thoughts with Us</strong>
                  </p>
      ...
      <section id="map" className="map-section">
        <div className="map-placeholder">
          <iframe
            title="Shamrock Irish Pub Location"
